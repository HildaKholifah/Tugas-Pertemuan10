...
class PokemonResponseModel {
  ...
  PokemonResponseModel({required this.pokemon});

  PokemonResponseModel copyWith({List<Pokemon>? pokemon}) =>
      PokemonResponseModel(pokemon: pokemon ?? this.pokemon);

  factory PokemonResponseModel.fromJson(String str) =>
      PokemonResponseModel.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory PokemonResponseModel.fromMap(Map<String, dynamic> json) =>
      PokemonResponseModel(
        pokemon: List<Pokemon>.from(
          json["pokemon"].map((x) => Pokemon.fromMap(x)),
        ),
      );
...
class Evolution {
  ...
  Evolution copyWith({String? num, String? name}) =>
      Evolution(num: num ?? this.num, name: name ?? this.name);
  ...
  Map<String, dynamic> toMap() => {"num": num, "name": name};
}
